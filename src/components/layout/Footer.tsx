                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 border-b border-white/10 pb-12">
                    ...
                    <div>
                        ...
                        <form className="space-y-3">
                            ...
                            />
                            <button suppressHydrationWarning={true} className="w-full bg-[#4ade80] hover:bg-[#22c55e] text-white font-bold py-3 px-6 rounded-full flex items-center justify-center gap-2 transition-colors uppercase text-sm tracking-wider">
                                <Mail size={18} />
                                SIGN UP
                            </button>
                        </form>
